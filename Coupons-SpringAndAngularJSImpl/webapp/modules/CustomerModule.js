(function(){
	...
	customerModule.service('CustomerService', function($http) {
		...
		this.createCustomer = function(data) {
			...
			$http.post('http://localhost:8080/Coupons/rest/customers/', data)			
		...
		this.updateCusromer = function(data) {
			...
			$http.put('http://localhost:8080/Coupons/rest/customers/', data)			
			.success(function(response) {
				alert(response);
			})
			.error(function(reponse) {
		...
		this.getCustomer = function(data) {
			...
			return $http.get('http://localhost:8080/Coupons/rest/customers/' + data)			
			.success(function(response) {
				return response;
			})
			.error(function(reponse) {
		...
		this.removeCustomer = function(data) {
			$http.delete('http://localhost:8080/Coupons/rest/customers/' + data)			
			.success(function(response) {
				alert(response);
			})
			.error(function(reponse) {
		...
		return $http.get('http://localhost:8080/Coupons/rest/customers/allcustomers')			
			.success(function(response) {
				return response;
			})
			.error(function(reponse) {
