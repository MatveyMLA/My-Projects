  (function() {
	...
	userModule.service('UserService', function($http, $window) {
		...
		this.loginFunction = function(data) {
			...
			return $http.put('http://localhost:8080/Coupons/rest/user/', data)			
		...
		this.companyRegisterFunction = function(data) {
			...
			$http.post('http://localhost:8080/Coupons/rest/user/companyregister', data)
				.success(function(response) {
		...
		this.customerRegisterFunction = function(data) {
			...
			$http.post('http://localhost:8080/Coupons/rest/user/customerregister', data)
				.success(function(response) {
		...
		this.logout = function() {
			...
			$http.delete('http://localhost:8080/Coupons/rest/user/')
				.success(function(response) {
				$window.location.assign("#/");
			})
			.error(function(reponse) {
		...
		this.removeUser = function(user) {
			...
			$http.delete('http://localhost:8080/Coupons/rest/user/removeuser', user)
			.success(function(response) {
			})
			.error(function(reponse) {
			})
