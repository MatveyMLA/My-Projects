...
public class CouponDao implements ICouponDao {
	...
	@Override
	public Collection<Coupon> getCouponsByCompanyAndEndDate(long companyId, Timestamp endDate)
	...
	public static void removeExpiratedCoupons() throws ApplicationException {
