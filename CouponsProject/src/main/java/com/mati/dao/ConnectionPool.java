...
public class ConnectionPool {
	...
	private static final int DEFAULT_AMOUNT_OF_CONNECTIONS = 20;
	private static final int MAX_AMOUNT_OF_CONNECTIONS = 100;
	private static final int MIN_AMOUNT_OF_CONNECTIONS = 10; 
